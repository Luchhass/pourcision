...
export default function useFillGame(options) {
  ...
  return {
    ...
    raceElapsedMs: game.raceElapsedMs,
    raceRoundElapsedMs: game.raceRoundElapsedMs,
    raceRoundStartedAtElapsedMs: game.raceRoundStartedAtElapsedMs,
    results: game.results,
    roundCount: game.roundCount,
    roundIndex: game.roundIndex,
    roundResetNonce: game.roundResetNonce,
    ...
    target: game.target,
    timeAttackFailNonce: game.timeAttackFailNonce,
